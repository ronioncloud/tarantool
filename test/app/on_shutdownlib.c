...
cfg(lua_State *L)
{
	...
	fail_unless(on_shutdown_trigger_replace(&module, on_shutdown_module_bad_func,
					 NULL) == 0);
	fail_unless(on_shutdown_trigger_replace(&module, on_shutdown_module_stop_func,
					 on_shutdown_module_bad_func) == 0);
	fail_unless(on_shutdown_trigger_replace(&module, on_shutdown_module_join_func,
					 NULL) == 0);
